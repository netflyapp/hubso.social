        ...
        {mockForumCategories.map((category, catIdx) => (
          ...
          >
            ...
            <div className="divide-y divide-gray-100 dark:divide-dark-border">
              {mockForumThreads.filter(t => t.categoryId === category.id).slice(0, 3).map((thread, thIdx) => (
                <a 
                  key={thIdx}
                  href="#" 
                ...
                >
                  <img 
                    src={thread.author.avatar || `https://images.unsplash.com/photo-${1438761681033 + thIdx}?w=50&h=50&fit=crop`} 
                  ...
                  <div className="flex-1 min-w-0">
                    <div className="flex items-center gap-2">
                      ...
                      {thread.views > 200 && !thread.pinned && (
                    ...
                    <p className="text-xs text-slate-400 dark:text-slate-500 mt-0.5">{thread.author.name} · {formatDate(thread.lastReplyAt)}</p>
                  </div>
